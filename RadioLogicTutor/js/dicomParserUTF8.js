...
/*
*******************************************************************************************************
*  new function added by Marco Barnig
*******************************************************************************************************
*/ 
...
function Utf8ArrayToStr(array) {
	...
	dicomParser.readUTF8String = function(byteArray, position, length)
	{
        if(length < 0)
        {
		...
		var result = "";
		var myArray = new Uint8Array(length);
        var byte;
        for(var i=0; i < length; i++)
        {
            byte = byteArray[position + i];
...
var dicomParser = (function (dicomParser)
{
	...
	*/ 
	 ...
	 dicomParser.DataSet.prototype.stringUTF8 = function(tag, index)
    {
        var element = this.elements[tag];
        if(element && element.length > 0)
        {
            var utf8String = dicomParser.readUTF8String(this.byteArray, element.dataOffset, element.length);
            return utf8String;
        }
        return undefined;
    };
